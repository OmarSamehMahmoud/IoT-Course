...
#define MQTT_BROKER_IP  "192.168.100.6"    // Local MQTT broker IP address
...
void mqtt_app_start(void)
{
    ...
    snprintf(broker_uri, sizeof(broker_uri), "mqtts://%s:8883", MQTT_BROKER_IP); // Note: mqtts:// and 8883

    esp_mqtt_client_config_t mqtt_cfg = {
        .broker.address.uri = broker_uri,
        .broker.verification.certificate = ca_cert_pem,  // ← TRUST YOUR CA
        .credentials.client_id = "esp32_dht11_secure",
